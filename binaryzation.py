# -*- coding: utf-8 -*-
"""
Created on Tue Apr 13 23:36:08 2021
...
input_name = os.listdir('datas/PedCut2013_SegmentationDataset/data/completeData/left_images/')
input_name1 = os.listdir('datas/PedCut2013_SegmentationDataset/data/testData/left_images/') 
n = len(input_name)
batch_size = 8
input_size_1 = 256
input_size_2 = 256
...
def batch_data(input_name, n, batch_size = 8, input_size_1 = 256, input_size_2 = 256):
    ...
    img1 = io.imread('datas/PedCut2013_SegmentationDataset/data/completeData/left_images/'+input_name[rand_num]).astype("float")
    img2 = io.imread('datas/PedCut2013_SegmentationDataset/data/completeData/left_groundTruth/'+input_name[rand_num]).astype("float")
...
img1 = io.imread('datas/PedCut2013_SegmentationDataset/data/testData/left_images/'+input_name1[15]).astype("float")
img1 = resize(img1, [input_size_1, input_size_2, 3])
img1 = np.reshape(img1, (1, input_size_1, input_size_2, 3))
img1 /= 255
...
plt.figure()
plt.imshow(img2)
img3 = io.imread('datas/PedCut2013_SegmentationDataset/data/testData/left_groundTruth/'+input_name1[15]).astype("float")
